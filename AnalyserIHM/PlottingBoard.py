...
from ObjectEventService import ObjectEventService
...
class PlottingBoard(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # in point tracking mode, this widget is to display the point found
        self.plottingPointDisplay = PlottingPointTracking()
